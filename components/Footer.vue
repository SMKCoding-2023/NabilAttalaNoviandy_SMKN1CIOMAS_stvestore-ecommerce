<template>
    <footer
        ...
        <p class="mb-4 text-sm text-center text-gray-500 dark:text-gray-400 sm:mb-0">
            &copy; 2023 <a href="https://flowbite.com/" class="hover:underline" target="_blank">stve store</a>. All
            rights reserved.
        </p>
        <div class="flex justify-center items-center space-x-1">
            <a href="https://github.com/nabilattala" target="_blank" data-tooltip-target="tooltip-github"
